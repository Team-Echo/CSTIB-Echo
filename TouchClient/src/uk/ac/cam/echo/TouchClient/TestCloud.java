 ...
 * @author Mona
 */
public class TestCloud extends Application {
    
    @Override
    public void start(Stage primaryStage) {
        
        Map mp = new HashMap();
        String[] words = {"Butt","Mona","Cat","Dog","Fs","Jam","Water","Plug","Nut","scamp","fajita","chin","mouth","crust","gherkin"};
        int i = 5;
        int width = 500;
        int height = 900;
        for (String s : words) 
        ...
        while(y_coord < height)
        {
            ...
            {
                //rewrite this section into setFontEmphasis
    ...
    private Font setFontEmphasis(String word, double weight, double maxweight, double minweight)
    {
        /**
